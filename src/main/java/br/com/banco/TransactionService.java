    ...
    public List<Transaction> getTransactions(
        ...
        try {
            ...
            if(operatorName != null && beginDate != null && endDate != null)
                return transactionRepository.findByPeriodAndOperatorName(accountId, dto.getBeginDate(), dto.getEndDate(), operatorName);
            ...
            if(beginDate != null && operatorName != null)
                return transactionRepository.findByBeginDateAndOperatorName(accountId, dto.getBeginDate(), operatorName);
